...
import { RiCompassDiscoverLine, RiCursorLine, RiGithubFill, RiPhoneFindLine, RiRocket2Line, RiTv2Line } from '@remixicon/react';
...
export default function Home() {
  return (
    <div className='w-full flex flex-col items-center'>
      <div className='flex h-fit w-full max-w-[848px]  gap-32 flex-col items-center justify-center border-l border-r border-stroke-soft-200 p-8'>
        <Header />
      ...
      <div className='flex w-full max-w-[848px] h-fit flex-col items-start justify-start'>
        {/* What? */}
        <div className='flex h-fit flex-col items-start justify-start self-stretch'>
          ...
          <div className='inline-flex items-start justify-start self-stretch'>
            <div className='flex h-[62px] items-center justify-center overflow-hidden border border-stroke-soft-200'>
              <img
                className='h-[62px] w-[422px] origin-top-left -rotate-180'
                src='https://via.placeholder.com/422x62'
              />
            </div>
            <div className='flex h-[62px] shrink grow basis-0 items-start justify-start gap-10 border border-stroke-soft-200 px-8 py-[15px]'>
              <div className='flex h-8 items-center justify-start gap-4'>
        ...
        <div className='flex h-[824px] flex-col items-start justify-start self-stretch'>
          ...
          <div className='inline-flex items-start justify-start gap-4 self-stretch border border-stroke-soft-200 p-8'>
            ...
            <img
              className='h-[154px] w-[154px] rounded-[217px]'
              src='https://via.placeholder.com/154x154'
            />
          </div>
        </div>
        ...
        <div className='flex h-[512px] flex-col items-start justify-start self-stretch'>
          ...
          <div className='inline-flex items-center justify-start gap-4 self-stretch border border-stroke-soft-200 p-8'>
            ...
            <FancyButton.Root variant='neutral'>Refer Client ($250)</FancyButton.Root>
          </div>
        </div>
